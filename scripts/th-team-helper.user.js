...
(function () {
  ...
  const CONFIG = {
    ...
    limitsFinder: {
      ...
      // названия колонки, в нижнем регистре). На разных листах сайта эта
      // колонка называется по-разному (Query Subagent на одних, просто
      // Subagent на других, например на ExtendedPaymentRequestList) —
      // подстрока намеренно короче полного названия, чтобы совпадать
      // с обоими вариантами
      column: 'subagent',
